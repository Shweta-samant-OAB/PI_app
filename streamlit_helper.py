...
def streamlit_setup(_title, _description):
    ...
    with col2:
        ...
        st.markdown(f'<p style="color:#f44336;font-size:40px;border-radius:1%;font-weight:bold;">'+_title+'</p>', unsafe_allow_html=True)
        st.markdown(f'<p style="color:#000000;font-size:14px;border-radius:1%;"> '+_description+'</p>', unsafe_allow_html=True)
        st.markdown(f'<p style="color:#000000;font-size:14px;border-radius:1%;font-weight:bold;"> '+_developer+'</p>', unsafe_allow_html=True)
